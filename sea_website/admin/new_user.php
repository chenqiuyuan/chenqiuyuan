...
if ($u_pass=="")
{ echo "<Script language=JavaScript>alert('抱歉，密码没有填写。');history.back();</Script>"; 
  exit;
}
...
$query = "SELECT * FROM web_user WHERE u_user='$u_user'";
$result = mysql_query($query) or die('SQL语句有误：'.mysql_error());
if (!mysql_num_rows($result))  
{  
//写入数据
$query = "INSERT INTO web_user (
u_user,
u_pass,
u_name,
u_class,
...
echo "<Script language=JavaScript>alert('抱歉，用户帐号已经存在，请更换后重试。');history.back();</Script>"; 
exit;	
	}
}
?>
...
<head>
	...
	<title>添加用户 - <?php echo $row['web_name']?></title>
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input name="u_user" type="text" class="m-wrap span12" id="firstName" placeholder="请填写用户帐号">
														...
														<div class="control-group">
															...
															<div class="controls">
															  <input name="u_pass" type="password" class="m-wrap span12" id="firstName" placeholder="请填写用户密码">
...
<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input name="u_name" type="text" class="m-wrap span12" > 
												...
												<div class="control-group">
															...
															<div class="controls">                                                
																...
																<input type="radio" name="u_class" value="0" />
																...
																<input type="radio" name="u_class" value="1" checked />
                                              ...
                                              <div class="row-fluid">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
<input name="u_images" type="text"  class="m-wrap span12" id="u_images" placeholder="需要时请点击浏览上传"> 
															</div>
