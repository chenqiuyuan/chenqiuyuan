...
//添加数据
$query = "INSERT INTO web_link
(name,mail,url,jieshao,nofollow,view_yes,time)
 VALUES 
('$name','$mail','$url','$jieshao','$nofollow','$view_yes',now())";
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					...
					<input name="name" type="text" class="m-wrap span12" placeholder="链接名称" >
                                                    ...
                                                    <div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
<input name="mail" type="text" class="m-wrap span12"  placeholder="请填写邮箱" >
...
<input name="url" type="text" class="m-wrap span12"  placeholder="请填写网址" value="http://" >
...
<input name="jieshao" type="text" class="m-wrap span12"  placeholder="请填写网站介绍">
						...
						<input name="nofollow" type="radio" value="0" checked="CHECKED" />
