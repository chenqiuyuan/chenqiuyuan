...
$post=$_POST["post"];
$wz_id=$_GET["edit"];
$query = "SELECT * FROM web_article WHERE url_address=$wz_id";
$result = mysql_query($query) or die('SQL语句有误：'.mysql_error());
...
<head>
	...
	<title>编辑文章 - <?php echo $row['web_name']?></title>
					...
					<div class="span12">
						...
						<div class="tabbable tabbable-custom boxless">
							...
							<ul class="nav nav-tabs">
								...
								<li class="active"><a href="#tab_1" data-toggle="tab">编辑文章</a></li>
								...
								<div class="tab-pane active" id="tab_1">
									...
									<div class="portlet box blue">
										...
										<div class="portlet-title">
											...
											<div class="caption"><i class="icon-reorder"></i>编辑文章</div>
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input name="w_title" type="text" class="m-wrap span12" id="firstName" placeholder="请填写文章标题" value="<?php echo $wz['w_title']?>">
...
?> 
<option value="<?php echo $n_id?>"  <?php echo $selected?>> <?php echo $list['n_name']?> </option>
<?php
}
?>
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input name="w_keywords" type="text" class="m-wrap span12" id="w_keywords"  placeholder="关键字，请以英文逗号隔开" value="<?php echo $wz['w_keywords']?>">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<label class="control-label" >描述</label><div class="controls">
															  <input name="w_description" type="text" class="m-wrap span12" id="w_description"  placeholder="请填写文章描述" value="<?php echo $wz['w_description']?>">
															</div>
                                                ...
                                                <div class="row-fluid">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
<input name="w_images" type="text"  class="m-wrap span12" id="w_images" placeholder="需要时请点击浏览上传" value="<?php echo $wz['w_images']?>"> 
															</div>
                                                    ...
                                                    <div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input name="w_author" type="text"  class="m-wrap span12" id="w_author" value="<?php echo $wz['w_author']?>"> 
...
?>													<div class="control-group">
															...
															<div class="controls">                                                
																...
																<input type="radio" name="view_yes" value="1" <?php echo $wzxs?> />
																...
																<input type="radio" name="view_yes" value="0" <?php echo $wzyc?>/>
...
<div class="controls">
<input name="w_hit" type="text" class="m-wrap span12" id="w_hit" value="<?php echo $wz['hit']?>"> 
</div>
</div>
</div>
                                                    <div class="span6 ">
...
?>														<label class="control-label" >推荐</label>
															...
															<div class="controls">                                                
																...
																<input type="radio" name="w_tuijian" value="1" <?php echo $tuijianon?>/>
																...
																<input type="radio" name="w_tuijian" value="0" <?php echo $tuijianoff?> />
